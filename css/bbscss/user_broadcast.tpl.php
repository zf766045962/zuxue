...
<p class="o pns">
<button   onclick = "hideWindow2()" id="closebtn" class="normalbtn bluebtn z" type="button" fwin="followmod"><strong>确定</strong></button>
		...
		alert(con)
				if(<?=$_SESSION['u_uidss']?> != 0 ){
					...
					if (window.XMLHttpRequest){
						...
						xmlhttp.open("GET","<?=URL('bbs2.send'),'&id='.V('r:id')?>",true);
						xmlhttp.send();		
...
<div id="append_parent1" style="">
<div style="display: none;" id="append_parent">

<div initialized="true" style="position: absolute; z-index: 601; left: 496px; top: 226px;" class="fwinmask" id="fwin_followmod"><style type="text/css">object{visibility:hidden;}</style><table cellspacing="0" cellpadding="0" class="fwin"><tbody><tr><td fwin="followmod" style="" class="m_c" id="fwin_content_followmod"><h3 style="cursor: move;" id="fctrl_followmod" class="flb"><em>提示信息</em><span><a href="javascript:;" class="flbc" onclick="hideWindow2();" title="关闭">关闭</a></span></h3>
<div class="c altw">
<div id="alert_error" class="alert_error">您已经收听过了</div>
</div>
<p class="o pns">
<button fwin="followmod" type="button" class="normalbtn bluebtn z" id="closebtn" onclick="hideWindow2()"><strong>确定</strong></button>
...
<div id="fwin_showMsgBox" class="fwinmask" style="position: absolute; z-index: 601; left: 502px; top: 99px;" initialized="true"><style type="text/css">object{visibility:hidden;}</style><table cellspacing="0" cellpadding="0" class="fwin"><tbody><tr><td id="fwin_content_showMsgBox" class="m_c login_showMsgBox" style="" fwin="showMsgBox"><div class="pm pm_chat">
<h3 class="flb" id="fctrl_showMsgBox" style="cursor: move;">
<span><a title="关闭" class="flbc" onclick="hideWindow('showMsgBox');" href="javascript:;">关闭</a></span></h3>
<div class="pm_tac bbda cl">
        	<div class="fll"><?=$nam[0]['username']?></div>
        	
<div class="shadebox_chat"></div>
</div>
        <div class="pm_avatar"><img onerror="this.onerror=null;this.src='http://common.res.meizu.com/resources/php/bbs/static/image/noavatar_big.gif'" src="<?=$nam[0]['avatar']?>"></div>
...
<div class="tedt">
<div style="display:none;" class="bar"><div class="fpd">
...
<script reload="1" type="text/javascript">smilies_show('pmsmiliesdiv', 8, 'pm');</script>
    <a onclick="seditor_fastUpload('pm', 'img');doane(event);" class="fmg" title="图片" href="javascript:;" id="pmimg" fwin="showMsgBox"><em></em></a>
    
</div>
<script type="text/javascript" src="http://bbs.res.meizu.com/resources/php/bbs/static/js/seditor.js?ffd"></script>
 </div>
<div class="area">
...
<div style="margin-top:20px;" class="mtn pns cl">
 					<button style="width:96px !important;" id="pmsubmit_btn" class="pn normalbtn bluebtn" type="submit" fwin="showMsgBox"><strong>发送</strong></button>
 					<div style="display:none;" class="pma mtn z">
<a onclick="refreshMsg();" title="刷新" href="javascript:;"><img class="vm" alt="刷新" src="http://bbs.res.meizu.com/resources/php/bbs/static/image/common/pm-ico5.png"> 刷新</a>
 					</div>
</div>
</form>
...
fObj.className = 'social_listen normalbtn bluebtn';
    ...
    <ul class="mbw tb cl page_frame_ul" style="padding-left:20px;" >
        <li class="a" ><a href="<?= URL('bbsUser.user_broadcast','&id='.V('r:id'))?>" >广播</a></li>
        <li  ><a href="<?= URL('bbsUser.user_thread','&id='.V('r:id'))?>" >主题</a></li>
...
<div class="feed_li_box" >      	            
            <div class="flw_article" style="margin-left:0; padding-left:0px;" >
                     ...
                     <a href="<?= URL('bbs.thread_detail','&tid='.$v['tid'])?>" target="_blank" ><?=$v['comment']?> <br />
</a>                 </div>
                <div class="flw_quote guide_list_replay">
<div class="arrow_guidelist"></div>
					<h2><?=$con66[0]['subject']?></h2>
                   <?=$con66[0]['content']?>                                              
                <div class="xg1 cl">
...
<span style="display: none;" id="subjectbox"><input style="width: 25em" tabindex="21" value="" class="px" id="subject" name="subject"></span>
    ...
    <div style="margin:30px 0px;">
        <button tabindex="23" name="" value="true" class="pn pnc" id="postsubmit<?=$v['id']?>" style="float:right; margin-left:20px;" type="submit" onclick="insert(<?=$v['id']?>,<?=$con66[0]['pid']?>)"><span>回复</span></button>
        <div class="cr"></div>
    </div>
...
<? $re5 = DS('publics._get','','bbs_postcomment',"tid='".$con66[0]['pid']."' and rpid = 0 and comment != '' order by dateline desc")?>
<? foreach($re5 as $k1=>$vv ){?>
<? if($k1 <= 5 ){?>
<li><a class="d xi2" href="space-uid-8385494.html"><?=$vv['author']?>&nbsp;&nbsp;</a><?=$vv['comment']?></li>
<? }else if($k1 == 6){?>
<div class="cl closebar_replybox">
	<a class="xi2" target="_blank" href="<?= URL('bbs.thread_detail','&tid='.$v['tid'])?>" style="margin-left:20px">去论坛查看所有回复<em class="arrow_2"> </em></a>
</div>
<?	}?>
<? }?>
</ul>
