...
define('MODEL_PATH',		P_COMS."/fields/");
...
define('V_JS_XPIPE_OBJ',	"XsmartPipe");
...
/// 使用Xsmart写的 cookie 前缀
define('COOKIE_NAME_PRE',		'xsm_');

/// 存储OAUTH 未授权信息的 SESSION 变量名
define('WB_OAUTH_KEYS1',	'XSM_OAUTH_NO_CONFIRM');
/// 存储OAUTH 已授权信息的 SESSION 变量名
define('WB_OAUTH_KEYS2',	'XSM_OAUTH_CONFIRM');
/// 存储用户会话数据的 SESSION 变量名
define('WB_CLIENT_SESSION',	'XSM_CLIENT_SESSION');
/// 存储管理员会话数据的 SESSION 变量名
define('WB_ADMIN_SESSION',	'XSM_ADMIN_SESSION');
//----------------------------------------------------------------------
define('WB_SOFT_NAME',			'XXXSMART');
define('WB_VERSION',			'0.2');
