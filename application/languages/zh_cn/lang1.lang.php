...
$_LANG['modules__note/list__add'] = '添加新记事';
$_LANG['modules__note/list__totalNote'] = '已有%s个记事';
$_LANG['modules__note/list__markAllReaded'] = '标记全部为已读';
$_LANG['modules__note__endPage'] = '最后一页';
$_LANG['modules__note__emptyTip'] = '暂无数据';
$_LANG['modules__note__add'] = '新记事';
$_LANG['modules__note__list'] = '记事列表';
$_LANG['modules__note__class'] = '记事分类';
$_LANG['modules__note__files'] = '附件';
$_LANG['modules__note__noticeTip'] = '当做<a href="%s">备忘录</a>，留个痕迹很重要。';
$_LANG['modules__note__title'] = '个人记事本';
$_LANG['modules__note__inputTips'] = '可以添加附件，但注意大小不要超过<span>%s</span>哦';
...
/// include
$_LANG['include__header__searchTip'] = '搜索内容';
...
$_LANG['include__header__bindSinaWeibo'] = '绑定开放平台账号';
...
/// 同城微博模块
$_LANG['pls__component8__getProvinces__apiError'] = 'Xsmart/xwb.getProvinces 返回API错误：%s(%s)';
...
/// input
$_LANG['modules__input__inputTitle'] = '有新鲜事告诉大家？！';
...
$_LANG['modules__input__inputReqGloalLogin'] = '您需要登录后才可以发布，';
$_LANG['modules__input__inputGoLogin'] = '现在就去登录';
...
$_LANG['modules__searchUser__addFollow'] = '加关注';
...
$_LANG['modules_microlive_live_detail_users_followed'] = '<span class="followed-btn">已关注</span>';
$_LANG['modules_microlive_live_detail_users_addFollower'] = '<a href="#" class="addfollow-btn" rel="e:fl,t:1"><span class="plus">+</span>加关注</a>';
...
///本地私信
$_LANG['modules__localpm/listGroupByUid__totalContact'] = '已有%s个联系人';
$_LANG['modules__localpm/listGroupByUid__totalPmNum'] = '共%s条私信';
$_LANG['modules__localpm/listGroupByUid__unreadPmNum'] = '未读%s条，';
$_LANG['modules__localpm/listGroupByUid__sendTo'] = '发给';
$_LANG['modules__localpm/listGroupByUid__markAllReaded'] = '标记全部已读';
$_LANG['modules__localpm/dialog__backToList'] = '返回所有私信';
$_LANG['modules__localpm/dialog__dialogBetweenMeAndPerson'] = '我和<em>%s</em>的对话';
$_LANG['modules__localpm/dialog__userNotExist'] = '该用户没有登录过该站点，私信功能不可用';
$_LANG['modules__localpm/setting__setting'] = '私信设置';
$_LANG['modules__localpm/setting__setWhoCanSend'] = '设置谁可以给我发私信';
$_LANG['modules__localpm/setting__all'] = '所有人<span>(不包括你的黑名单用户，部分用户会受到反垃圾系统限制，依然不能给你发送私信)</span>';
$_LANG['modules__localpm/setting__myattention'] = '我关注的人';
...
$_LANG['adapter__load__fileUpload__uploadFileMine'] = '上传文件MIME类型不允许！';
...
$_LANG['common__template__unknownuser'] = '未知用户';
$_LANG['common__template__me'] = '我';
...
$_LANG['modules__footer__verify'] = '如何认证';
$_LANG['modules__mod_verify__whatis'] = '什么是认证？';
$_LANG['modules__mod_verify__description'] = '当用户名旁点亮<img src="%s">图标，说明%s微博已经验证了该帐号的真实性。';
$_LANG['modules__mod_verify__howto'] = '如何认证？';
$_LANG['modules__mod_verify__mailto'] = '填写以下信息并发送邮件到%s提交审核：';
$_LANG['modules__mod_verify__msg'] = '<p>1、你在%s的昵称</p>	<p>2、个人身份说明介绍</p>	<p>3、希望被认证的头衔或称谓。</p>';
$_LANG['modules__mod_verify__admin'] = '管理员';
