<?php
/**
 * @file			saeproxy_http.adp.php
 * @CopyRright (c)	2006-2099Inc.
 * @Project			Xsmart 
 * @Author			@@
...
//		$this->_curlInit = curl_init();
		...
		$header_array['Signature'] = base64_encode(hash_hmac('sha256',
		$content, $_SERVER['HTTP_SECRETKEY'] ,true));
		//将$header_array拼到$header_array2，转为curl可识别的Header数组
		$header_array2=isset($this->_option[CURLOPT_HTTPHEADER])?$this->_option[CURLOPT_HTTPHEADER]:array();
		foreach($header_array as $k => $v)
		array_push($header_array2,$k.': '.$v);
		
		curl_setopt($this->_curlInit, CURLOPT_HTTP_VERSION, CURL_HTTP_VERSION_1_0); 
		curl_setopt($this->_curlInit, CURLOPT_HTTPHEADER, $header_array2 );
		curl_setopt($this->_curlInit, CURLOPT_URL, SAE_FETCHURL_SERVICE_ADDRESS );
...
//		echo '<br />';
//		print_r($header_array2);
//		echo '<br />';
//		echo '<br />';
//		echo 'CURLOPT_URL===>';
//		echo '<br />';
//		print_r(SAE_FETCHURL_SERVICE_ADDRESS);
//		echo '<br />';
//		echo '<br />';
//		echo 'CURLOPT_POSTFIELDS===>';
//		echo '<br />';
//		print_r($this->_option[CURLOPT_POSTFIELDS]);
//		echo '<br />';
//		echo 'curl_exec ====>';
//		echo '<br />';
//		print_r($this->_server_content);
//		exit;
