...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>是否为密码框</td>
      <td><label><input type="radio" name="setting[ispassword]" value="1" <?php if($setting['ispassword']) echo 'checked';?>> 是 </label><label><input type="radio" name="setting[ispassword]" value="0" <?php if(!$setting['ispassword']) echo 'checked';?>> 否</label></td>
    </tr>
</table>