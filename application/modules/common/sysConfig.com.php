...
class sysConfig {
	...
	var $options = array(   
							...
							'logo'	 					=> '',					//logo图标
							'logo_wap'					=> '',					//wap logo
							'logo_link'					=> '1',					// Logo链接为我的首页或广场,1为广场,2为我的首页set
							'logo_output'				=> '',					//输出模块logo
							'address_icon' 				=> '',					//网站地址图标			
							'login_way' 				=> '2',					//登录方式 1.仅使用新浪帐号直接登录 2.仅使用原有站点帐号登录 3. 使用新浪帐号与原有站点帐号并存方式登录
