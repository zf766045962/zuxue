<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
	  ...
	  </select> <span id="minnumber" style="display:none"><label><input type="radio" name="setting[minnumber]" value="1" checked/> <font color='red'>正整数</font> </label><label><input type="radio" name="setting[minnumber]" value="-1" /> 整数</label></span>
	  </td>
    </tr>
...
<tbody id="setsize" style="display:none">
	...
	<tr> 
      <td>输出格式</td>
      <td>
	  <label><input type="radio" name="setting[outputtype]" value="1" checked /> 输出选项值 </label>
	  <label><input type="radio" name="setting[outputtype]" value="0" /> 输出选项名称 </label>
	  </td>
    </tr>
	<tr> 
      <td>是否作为筛选字段</td>
	  ...
	  <label><input type="radio" name="setting[filtertype]" value="0"/> 否 </label>
	  </td>
    </tr>	
</table>
