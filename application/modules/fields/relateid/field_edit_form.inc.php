...
<table cellpadding="2" cellspacing="1" width="98%">
    ...
    <tr>
        <td>是否显示关联项</td>
        <td>
            <label><input name="setting[isShowTit]" value="1" type="radio" <?= $setting['isShowTit'] == 1 ?'checked' : '';?>>
            是</label>
            <label><input name="setting[isShowTit]" value="2" type="radio" <?= $setting['isShowTit'] == 2 ?'checked' : '';?>>
            否</label>
        </td>
    </tr>
    <tr>
