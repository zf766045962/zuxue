...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>表单显示模式</td>
      <td><label><input type="radio" name="setting[show_type]" value="1" <?php if($setting['show_type']) echo 'checked';?>/> 图片模式 </label><label><input type="radio" name="setting[show_type]" value="0" <?php if(!$setting['show_type']) echo 'checked';?>/> 文本框模式</label></td>
    </tr>
	<tr> 
      <td>允许上传的图片大小</td>
	...
	<tr> 
      <td>是否在图片上添加水印</td>
      <td><label><input type="radio" name="setting[watermark]" value="1" <?php if($setting['watermark']) echo 'checked';?>> 是 </label><label><input type="radio" name="setting[watermark]" value="0" <?php if(!$setting['watermark']) echo 'checked';?>> 否</label></td>
    </tr>
	<tr> 
      <td>是否从已上传中选择</td>
      <td><label><input type="radio" name="setting[isselectimage]" value="1" <?php if($setting['isselectimage']) echo 'checked';?>> 是 </label><label><input type="radio" name="setting[isselectimage]" value="0" <?php if(!$setting['isselectimage']) echo 'checked';?>> 否</label></td>
    </tr>
	<tr> 
      <td>图像大小</td>
