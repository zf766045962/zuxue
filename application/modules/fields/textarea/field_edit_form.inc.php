...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>是否允许Html</td>
      <td><label><input type="radio" name="setting[enablehtml]" value="1" <?php if($setting['enablehtml']==1) {?>checked<?php }?>> 是 </label><label><input type="radio" name="setting[enablehtml]" value="0" <?php if($setting['enablehtml']==0) {?>checked<?php }?>> 否</label></td>
    </tr>
</table>