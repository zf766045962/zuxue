...
class Xpipe {
	...
	*/
    public static function module($r, $p=array(), $o=false,$isPerch=true){
	...
	* @param mixed $isPerch 是否输出占位标签,非占位pagelet可用
	*/
    public static function pagelet($r, $p=array(), $o=false,$isPerch=true){
		static $ost= 1000000,$custom_st = 1000001,$ki=10000;
		$ki++;
		$k =  $o==false ? $ost-- : $custom_st+$o;		
		//echo $k,"-",$ost,"\n";
	...
	* 占位标签,用于确定模块要显示的位置
	*/
    public static function _perchLable($k,$r){
	...
	* @param mixed $pl
	*/
    public static function runOnePagelet($pl){
		//sleep(2);
		ob_start();
