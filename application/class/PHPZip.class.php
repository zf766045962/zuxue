...
class PHPZip{
	...
	function ZipDir($dir,$zipfilename,$Todo){
		...
		switch ($Todo){
		case "1":
		$this -> DownLoad(WEBSITE_URL,$zipfilename,$out);
		break;
		case "2":
		$this -> SaveFile(WEBSITE_URL,$zipfilename,$out);
			break;
		}
	}
	...
	function addFile($data,$name,$time=0){
		...
		$name		= str_replace(dirname($name).'/','',$name);
