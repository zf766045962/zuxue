...
<body class="main-body">
	<div class="path">
	  <p>当前位置：后台管理<span>&gt;</span><?=$groupname?>分类管理<span>&gt;</span></p></div>
         <div class="main-cont">
        <h3 class="title"><?=isset($info['classid']) && intval($info['classid'])>0?"修改":"添加"?><?=$groupname?>分类</h3>
        <div class="set-area">
        <form  name="form1a" id="form1a" method="post" action="<?php echo URL('mgr/group.saveclass')?>">
