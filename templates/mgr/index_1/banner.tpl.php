...
<body class="main-body">
	<div class="path"><p>当前位置：后台管理<span>&gt;</span><?=$adname?>管理<span>&gt;</span><?=$adname?></p></div>
        <div class="main-cont">
        <h3 class="title"><a class="btn-general" href="<?php echo URL('mgr/index_1.addclass','&classid='.V('r:classid'))?>"><span>添加<?=$adname?></span></a>
		...
		<colgroup>
            ...
            <tr>
			 ...
			 <td><?=$couunm?></td>
              ...
              <td><?= $rs["lmorder"];?></td>
              <td>
                <a class="icon-edit" href="<?=URL("mgr/index_1.addclass","bid=".V("r:bid")."&classid=".V("r:classid")."&pid=".$rs["pid"]."&recommend=".V("r:recommend")."&audit=".V("r:audit")."&top=".V("r:top")."&page=".V("r:page",1)."&key=".urlencode(V("r:key"))."")?>">修改</a>
