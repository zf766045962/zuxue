...
<body class="main-body">
	<div class="path">
	  <p>当前位置：后台管理<span>&gt;</span><?=$adname?>管理<span>&gt;</span><?=isset($info[0]['classid']) && intval($info[0]['classid'])>0?"修改":"添加"?><?=$adname?></p></div>
        ...
        <div class="set-area">
        <form  name="form" id="form"  method="post" action="<?php echo URL('mgr/index_1.saveban','&classid='.V('r:classid'))?>">
                <div class="form web-info-form">
					...
					<div class="form-row">
							 ...
							 <div class="form-cont">
							<select name="data[fid]" id="fidplant">
