...
<div class="main-wrap">
    ...
    <div class="main-cont">
        ...
        <div class="set-area">
        	<div class="form web-info-form">
            	<form action="" name="form1" method="post" id="this_form">
                    ...
                    <div class="form-row">
                        <label class="form-field">网站备案号</label>
                        <div class="form-cont">
                            <input name="site_record" class="input-txt" vrel="sz=max:200,m:请缩减至二百个字内|ne=m:不能为空" warntip="#nameTip" type="text" value="<?php echo $config['site_record']; ?>" /><span class="tips-error hidden" id="nameTip"></span>
                            
                        </div>
                    </div>
					
					<div class="form-row">
                        <label class="form-field">学币设置</label>
                        <div class="form-cont">
                            <input name="site_money" class="input-txt" style="width:10px;" warntip="#nameTip" type="text" value="1" readonly/>元&nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;<input name="site_learn" class="input-txt" warntip="#nameTip" type="text" style="width:30px;" value="<?php echo $config['site_learn']; ?>"  />学币<span class="tips-error hidden" id="nameTip"></span>
                        <p class="form-tips">（例如：1元=10学币）</p>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-cont">
                        <textarea name="site_keyword" class="input-area area-s4 code-area" cols="10" rows="10"><?php echo $config['site_keyword']; ?></textarea>
                          <p class="form-tips">（网站关键字）</p>
                        </div>
                    </div>
                    <div class="form-row">
                        <label class="form-field">描述信息</label>
                        <div class="form-cont">
                        <textarea name="site_meat" class="input-area area-s4 code-area" cols="10" rows="10"><?php echo $config['site_meat']; ?></textarea>
                          <p class="form-tips">（网站描述信息）</p>
                        </div>
                    </div>
                    <div class="form-row" style="display:none;">
                        <label class="form-field">联系电话</label>
                        <div class="form-cont">
                            <input name="site_tel" class="input-txt" vrel="sz=max:30,m:最多30个中文或60个英文字母" type="text" warntip="#codeErr" value="<?php echo $config['site_tel']; ?>" /><span class="tips-error hidden" id="codeErr"></span>
                            <p class="form-tips">（联系电话将显示在页面底部）</p>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <?php 		if(V('-:appmode/member_sina',0)){
					?>
                    <div class="form-row">
                        <label for="declare" class="form-field">使用新浪微博同步登陆</label>
                        <div class="form-cont">
                    ...
                    <?php 		if(V('-:appmode/language',0)){ ?>
                    <div class="form-row">
                        <label class="form-field">选择前台使用语言</label>
                       <div class="form-cont">
                        	<label><input type="radio" name="wb_lang_type" value="en" <?php if (isset($config['wb_lang_type'])  && ('en'==$config['wb_lang_type'])){echo 'checked="checked"'; } ?> />英文版</label>
        ...
        <form id="logo_form" target="logo_upload" method="post" style="" action="<?php echo URL('mgr/setting.uploadLogo')?>" enctype="multipart/form-data">
        <h3 class="title" style="display:none;">请选择需要在网站中使用的LOGO图案</h3>
        <div class="set-area">
            <div class="form web-info-form"> 
                <div class="form-row" style="display:none;">
                ...
                <div class="form-row logo_preview" style="display:none;">
                    <label for="upload_file" class="form-field">效果预览</label>
                    <div class="form-cont">
                        <img id="logo_preview" src="<?php echo $config['logo'] ? F('fix_url', $config['logo']) : W_BASE_URL . 'img/logo.png';?>" />
