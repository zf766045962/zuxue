...
<script type="text/javascript">
	var addHtmlMode=['<form action="<?php echo URL('mgr/usergroup.editusergroup');?>" method="post" id="form1"  name="add-newlink">',
					...
					'			<div class="form-cont">',
					'				<input id="g_name" name="g_name" class="ipt-txt" type="text" value="用户组说明" warntip="#linkTip1" vrel="_f|sz=max:255,m:不能超过255字符|ne=m:不能为空"/><span class="tips-error hidden" id="linkTip1"></span>',
					'			</div>',
					'		</div>',
					'		<div class="form-row">',
					'			<label for="g_name1" class="form-field">说明</label>',
					'			<div class="form-cont">',
					'				<input id="g_name1" name="g_name1" class="ipt-txt" type="text" value="用户组说明" warntip="#linkTip2" vrel="_f|sz=max:255,m:不能超过255字符|ne=m:不能为空"/><span class="tips-error hidden" id="linkTip2"></span>',
					'			</div>',
					'		</div>',					
					'		<div class="form-row">',
					'			<label for="g_name1" class="form-field">说明</label>',
					'			<div class="form-cont">',
					'				<input id="g_name1" name="g_name1" class="ipt-txt" type="text" value="用户组说明" warntip="#linkTip3" vrel="_f|sz=max:255,m:不能超过255字符|ne=m:不能为空"/><span class="tips-error hidden" id="linkTip3"></span>',
					'			</div>',
					'		</div>',					
					'		<div class="form-row">',
					'			<label for="g_name1" class="form-field">说明</label>',
					'			<div class="form-cont">',
					'				 <textarea name="third_code" class="input-area area-s4 code-area" cols="5" rows="10" " warntip="#linkTip3" vrel="_f|sz=max:255,m:不能超过255字符|ne=m:不能为空"></textarea></span>',
					'			</div>',
					'		</div>',					
...
<body>
<div class="main-body">
	<div class="path"><p>当前位置：用户组管理<span>&gt;</span>用户组管理</p></div>
    <div class="main-cont">
        <h3 class="title"><a class="btn-general" href="javascript:add('head');"><span>添加新的用户组</span></a>用户组接列表</h3>
        <div class="set-area">
            <table class="table" cellpadding="0" cellspacing="0" width="100%" border="0">
                ...
                <thead class="tb-tit-bg">
                    <tr>
                        <th><div class="th-gap">用户组名称</div></th>
                        <th><div class="th-gap">属性</div></th>
