    ...
    <div class="main-cont">
    	...
    	<div class="set-area">
			<div class="form-s1">
				...
				<p class="tips">个性化域名需要服务器支持Rewrite功能，以下提供的规则只适用于<strong class="stress" >Apache</strong>服务器，并且安装在<strong class="stress" >根目录</strong>，规则如下：</p>
				<ul>
					<li>1.确保Apache安装了Rewite模块，并将Apache配置文件中的AllowOverride设置为All</li>
					<li>2.找到根目录下的.htaccess文件，将“RewriteEngine off”前面的#号去掉，并改为“RewriteEngine on”</li>
