...
<!--<div class="main-wrap">
    ...
    <div class="main-cont">
		...
		<div class="set-area">
        	<div class="form-s1">
            	<p class="tips">如果你安装了fm for Discuz 插件，可以通过设置共享双方帐号绑定关系和内容的互推。</p>
                <p class="tips">在开始设置之前请先确定：</p>
                <ul>
                	<li>1.你的Framework和Framework for Discuz 插件使用的是同一个appkey；</li>
                    <li>2.你的论坛所使用的程序是DiscuzX1.5,Discuz6.0-7.2；</li>
                    <li>3.你所装的Framework版本是2.0或者以上的</li>
                    <li>4.你所装的Framework for Discuz 插件版本在2.0或以上</li>
                </ul>
