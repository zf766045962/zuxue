    	...
    	<div class="con-border">
            ...
            <form action="" method="post" onsubmit="check();return false;">
            	<div class="active-area">
            		<div class="admin-tit"><span class="icon-pwd"></span>管理员密码设置<span>(该密码用于登录管理后台)</span></div>
                	<div class="admin-cont">
            			<div class="info-row">
                			<label><span class="required">*</span>微博帐号：</label>
                    		<strong><?php echo $real_name;?></strong>（<?php echo $cc_uid;?>）
                		...
                		<div class="info-row">
                            ...
                            <p class="tips">请登录<A href="#" target="_blank">开放平台</A>，查询您申请的APPKEY</p>
						</div>
						 <div class="info-row">
