...
<link href="<?php echo W_BASE_URL;?>css/admin/admin2.css" rel="stylesheet" type="text/css" />
...
<body class="main-body">
	...
	<div class="main-cont">
        ...
        <div class="set-area">
            ...
            <form method="post" id="form1" action="<?= URL('mgr/page_nav.updateNav');?>">
                    ...
                    <?php 
                        ...
                        function aNavHtml($data, &$pageList, $isSon=FALSE)
                        {
                            ...
                            if ($data['page_id'] && isset($pageList[$data['page_id']])) 
                            {
								...
								} elseif ($data['page_id'] == 3) {
                                    $editLink = '<a href="'. URL('mgr/celeb_mgr.setting') .'" class="icon-set">设置</a>';
								} else {
									$editLink = '';	
