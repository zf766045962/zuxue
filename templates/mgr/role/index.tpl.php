...
<div class="main-cont" style=" line-height:24px">
    <h3 class="title">
        <a class="btn-general" href="<?= URL('mgr/role.add');?>"><span>添加角色</span></a>角色列表 
    </h3>
</div>
<div class="pad_10">
    <div id="searchid">
            ...
            <table width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align='center'>
						<a href="<?= URL('mgr/role.rcourse','id='.$val['id']);?>">
						<a onclick="dialog('<?= URL('mgr/role.rcourse','id='.$val['id']);?>','设定课程价格',800,600)" style="cursor:pointer">设定课程价格</a> 
						 |
						 <a onclick="dialog('<?= URL('mgr/role.rsystem','id='.$val['id']);?>','设定体系价格',790,600)" style="cursor:pointer">设定体系价格</a> 
						 |
