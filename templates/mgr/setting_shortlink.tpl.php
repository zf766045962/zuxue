    	...
    	<div class="set-area">
        		<div class="form-s1">
					<?php if (XWB_SERVER_ENV_TYPE!=='sae'){ ?>
                        ...
                        <p class="tips">短链接需要服务器支持Rewrite功能，以下提供的规则只适用于<strong class="stress">Apache</strong>服务器，并且Xsmart安装在<strong class="stress">根目录</strong>，规则如下：</p>
                        <ul>
                            <li>1.确保填写的短链接域名可以解析并和服务器绑定</li>
                            <li>2.确认域名的Apache开启了Rewrite功能，并将Apache配置文件中的AllowOverride设置为All</li>
                            <li>3.找到根目录下的.htaccess文件，复制到指定域名的服务器根目录下</li>
