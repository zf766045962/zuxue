                    ...
                    <?php if(isset($usergroup) && is_array($usergroup)):?>
                        <?php foreach($usergroup as $key=>$value):?>
                            <tr>
                                ...
                                <td><a class="icon-edit" title="编辑" href="javascript:edit('<?php echo $value['gid'];?>','head')">设置权限</a><a class="icon-edit" title="编辑" href="javascript:edit('<?php echo $value['gid'];?>','head')">编辑</a><a class="icon-del" title="删除" href="javascript:delConfirm('<?php echo URL('mgr/usergroup.del','action=del&gid='.$value['gid']);?>');">删除</a></td>
                            </tr>
                        <?php endforeach;?>
                    <?php endif;?>
                </tbody>
