...
<body class="main-body">
	<div class="path">
	  <p>当前位置：后台管理<span>&gt;</span><?=$linkname?>管理<span>&gt;</span><?=isset($info['classid']) && intval($info['classid'])>0?"修改":"添加"?><?=$linkname?></p></div>
         <div class="main-cont">
        <h3 class="title"><?=isset($info['classid']) && intval($info['classid'])>0?"修改":"添加"?><?=$linkname?></h3>
        <div class="set-area">
        <form  name="form" id="form"  method="post" action="<?php echo URL('mgr/link.savelink')?>">
                <div class="form web-info-form">
                  ...
                  <div class="form-row">
                     ...
                     <div class="form-cont">
                       <input name="data[http]" type="text" class="input-txt" id="data[http]"  value="<?=isset($info["http"])&&!empty($info["http"])?$info["http"]:"http://"?>" maxlength="50">
                  	</div>
                  </div> 
                  <div class="form-row">
