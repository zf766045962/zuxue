...
<div class="path">
  <p>当前位置：系统管理<span>&gt;</span>应用管理列表</p>
</div>
<div class="main-cont">
  <h3 class="title"><a rel="e:addpage" class="btn-general"><span onclick="openPop('<?=URL("mgr/permit.appAdd")?>','创建应用')">创建应用</span></a>应用管理列表</h3>
  <div class="set-area">
    ...
    <table class="table" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <thead class="tb-tit-bg">
	    <tr>
          ...
          <th>&nbsp;<div class="icon-edit" onclick="openPop('<?=URL("mgr/permit.appAdd",$appinfo)?>','编辑应用')">编辑应用</div></th><th>&nbsp;<div class="icon-add" onclick="openPop('<?=URL("mgr/permit.moduleAdd",$appinfo)?>','增加模块')">增加模块</div></th>
        </tr>
      </thead>
...
?>
    <p class="suggest-tips">*温馨提示：<br />
      当中只有部分页面支持设置，如果某个页面设置之后，它的子页面会自动
</p>
  </div>
