...
var HtmlDemo=[ '<form id="pwdForm" action="<?php echo URL('mgr/usergroup.add');?>" method="post">',
            	'	<div class="form-box">',
            	'		<div class="form-row">',
            ...
            <?php elseif(isset($list)):?>
              <ul class="search-results">
                ...
                <?php if($i==1):$i++;?><li class="first"><?php else:?><li class="result-line"><?php endif;?>
                    ...
                    <div class="results-r">
                        <a href="javascript:add('<?php echo $value['cc_uid'];?>','<?php echo htmlspecialchars($value['nickname']);?>')" >添加管理员权限</a>
                    </div>
                </li>
                <?php endforeach;?>
              </ul>
