...
<body class="main-body">
    ...
    <div class="main-cont">
		...
		<div class="set-area">
			...
			<div class="form-s1">
				<p class="tips"><strong>认证申请邮箱:</strong></p>
				<p class="operate">
                    <label>
					接收认证资料的邮箱：<input type="text" name="authen_request_email" value="<?php echo isset($sysconfig['authen_request_email'])?$sysconfig['authen_request_email']:'';?>" />
					</label>
				</p>
