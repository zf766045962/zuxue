...
var __gloCfg={
	'language'	:  '<?php echo V('-:sysConfig/wb_lang_type');?>',
	'version'	:	'<?php echo WB_VERSION;?>',
	'project'	:	'xsmart'
	
};
</script>
<script src="<?php echo W_BASE_URL;?>js/jquery.js"></script>
<script src="<?php echo W_BASE_URL;?>js/xwb.zh_cn.js"></script>

<script type="text/javascript">
 Xwb.use('Validator', {
     // 当前表单form元素
     form:jq.find('#staruserfrm'),
     // 触发提交按钮
     ...
     onsuccess : function(data, next){
         ...
         return false;
				...
				<form action="<?php echo URL('mgr/celeb_mgr.saveStar');?>" method="post"  name="add-newlink" id="staruserfrm">
					...
					<input type="hidden" name="cc_uid" value="<?php echo isset($info['cc_uid']) ? $info['cc_uid'] : ''; ?>" />
                    <div class="form-box">
                        ...
                        <div class="btn-area">
                            <a class="btn-general highlight" href="#" id="trig"><span>确定</span></a>
