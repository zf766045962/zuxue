		...
		<div class="set-area">
            ...
            <table class="table" cellpadding="0" cellspacing="0" width="100%" border="0">
                ...
                <?php if(isset($list) && is_array($list) && !empty($list)):?>
				 ...
				 <?php if(!F('user_action_check',array(3),$value['cc_uid'])) :?>
                    <tr>
                        <td>
                            <?php echo ++$num;?>
                        </td>
                        <td>
                            <a href="<?php echo URL('ta', 'id='.$value["cc_uid"], 'index.php'); ?>"  target="_blank" ><?php echo F('escape', $value['nick']); ?></a>
                        </td>
                        <td>
                        ...
                        <td>
                                <a class="icon-edit" href="javascript:openPop('<?php echo URL('mgr/celeb_mgr.addStar', 'c_id1=' . $value['c_id1'] . '&c_id2=' . $value['c_id2']) . '&cc_uid=' . $value['cc_uid']; ?>','编辑名人信息');">编辑</a>
                                <a class="icon-del" href="javascript:delConfirm('<?php echo URL('mgr/celeb_mgr.delStar', 'c_id1=' . $value['c_id1'] . '&c_id2=' . $value['c_id2'] . '&cc_uid=' . $value['cc_uid']); ?>','确认要删除吗？')">删除</a>
                        </td>
                    </tr>
					<?php endif;?>
                 <?php endforeach;?>
