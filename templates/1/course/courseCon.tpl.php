...
<meta name="description" content="<?php echo $ad_list[0]['description']?>_学啊网">
	...
	<meta name="description" content="<?= $slist['description']?>_学啊网">
    <?php }?>      
...
<div class="content">
	<div class="con_top">
    	<img width="600" height="338" src="<?= $slist['thumb']?>">
        <div class="top_right">
            <h3><?= $slist['stitle']?></h3>
            <style>
            ...
            <div class="fenxiang">
                <a href="javascript:;" onclick="collect(<?= $slist['id']?>,2)" title="收藏" class="star"></a>
                <a href="javascript:;" onclick="share(<?= $slist['id']?>,2)" title="分享" class="share"></a><br />
...
<script>
    ...
    <div class="tanchu_one" id="a2" style="display:none">
        ...
        <div class="clearfloat"></div>
        <div class="xiangxi" id="xiangxi2"></div>
        <p id="pricess2" class="pricess">价格：1学币</p>
    ...
    <div class="tanchu_one" id="a3" style="display:none">
        ...
        <div class="clearfloat"></div>
        <div class="xiangxi" id="xiangxi3"></div>
