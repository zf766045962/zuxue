...
<title><?php echo $univer[0]['title'];?></title>
 

<meta name="keywords" content="<?= $univer[0]['keyword']?>">  
<meta name="description" content="<?= $univer[0]['description']?>">
...
<?php TPL :: display("header1")?>
    ...
    ?>
			...
			<div class="clearfloat"></div><div class="fenye"><?= $pager?></div>
