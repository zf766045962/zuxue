...
<div class="index_show">
	<div id="aa" style="width:100%; text-align:center; position:absolute; top:240px;"><img src="images/zr.gif" /></div>
	<!--banner-->
...
?>
		<a href="<?= (empty($bv['http']) || $bv['http']=="http://")?'javascript:;':$bv['http']?>"><li class="item<?= $bk+1?>" style="background: url(<?= $bv['imgurl']?>) center 0 no-repeat;"></li></a>
       <!-- <li class="item2" style="background: url(images/banner4.jpg) center 0 no-repeat;"></li>-->
<?php 
		}
	}
?>
	</ul>
	<div style="width:1440px;height:28px;margin:0 auto;position:absolute;bottom:0;left:0;background:url(images/back.png);">
		<div id="bx-pager">    
...
function inter(schid){
	...
	<div class="news">
    	<!--明星学员-->
		<div class="news_left">
			<h3 class="news_title" style="text-align:left;display:block;margin:10px 0 5px 20px;">明星学员</h3>
		...
		?> 
			<div class="a1"> 
				<div class="b1" onMouseOver="setTimeout('tab( )', 500)" onMouseOut="ta()" style="width:250px;">
					<img src="<?= $sv['head_img']?>" style="width:250px;height:111px;" />
				</div>
				<div class="b2" style="left:258px;">
					<span style="color:#fff;font-size:15px;font-weight:bold;display:block;margin:10px 15px;"><?= $sv['realname']?></span>
					<span style="color:#beebf0;display:block;margin:0 15px;"><?= $sv['startname']?></span>
					<span style="display:block;color:#beebf0;float:left;margin:10px 15px;">学习<span style="color:#fff;display:block;"><?= $sv['studytime']?></span></span>
					<span style="display:block;color:#beebf0;float:right;margin:10px 15px;">报名<span style="color:#fff;display:block;"><?= $sv['studynum']?>门课程</span></span>
				</div>
				<div class="clearfloat"></div>
			</div>
        <?php }else if($sk==1){?>
            <div class="a1">
            	<div class="b1" onMouseOver="setTimeout('tab( )', 500)" onMouseOut="ta()" style="width:121px;">
					<img src="<?= $sv['head_img']?>" style="width:121px;height:111px;" />
				</div>
       ...
       <!-- 新闻喜讯-->
		<div class="news_right">
			<div class="news_cen_btm">
				<h3 class="news_title">
				<?
					 echo $news_activity1[0]['classname'];
				?>       
				</h3>
				<img src="images/xuea_img_70.png"/>
				<ul>
