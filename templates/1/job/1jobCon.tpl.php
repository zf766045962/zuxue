...
<div class="con_top">
    ...
    <div class="top_right">
        ...
        <div class="fenxiang">
             <a href="javascript:;" onclick="collect(<?= $slist['id']?>,<?= $catid?>)" title="收藏" class="star"></a>
            <a href="javascript:;" onclick="share(<?= $slist['id']?>,4)" id="fenxiang" title="分享" class="share"></a><br />
        ...
        <div class="clearfloat"></div>
        <p><?= $slist['introduce']?></p>
        <div class="buy"><a href="javascript:void(0);" onclick="checkBuy(<?= $slist['id']?>,0,0,4,1)">购买此课程</a></div>
...
?>
            ...
            ?>  
                        <li aid="<?=$vkc['id']?>"><a href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>" class="buy_title"><?= $vkc['name'];?></a>
                        	<div id="shipin_title<?=$vkc['id']?>"  style="display:none;float:left;position:absolute;left:275px;z-index:3;top:0;width:370px;">
                            	<p style="display:inline-block;"><img src="images/course_conimg_18.png" /></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;"><?= $courinfo[0]['kc_hours']?></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;">赞（<?= $courinfo[0]['good']?>）踩（<?= $courinfo[0]['bad']?>）</p>
                            </div>
                        	<span class="xuxian"></span><a class="buy_xj" href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>">已购买</a><a href="javascript:;" class="buy_xj" <?= $userInfo['type']==2?'onclick="goExam('.$vkc['id'].')"':''?>>测评</a></li>
            <?php 	}	
				}
			?>
                    </ul>
                   ...
                   foreach($arr as $kkc => $vkc){
                    ...
                    ?>   
                            ...
                            <div id="shipin_title<?=$vkc['id']?>"  style="display:none;float:left;position:absolute;left:350px;z-index:3;top:0;width:370px;">
                            	<p style="display:inline-block;"><a href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>" class="buy_title"><img src="images/course_conimg_18.png" /></a></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;">课时：<?= $courinfo[0]['kc_hours']?></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;">赞（<?= $courinfo[0]['good']?>）踩（<?= $courinfo[0]['bad']?>）</p>
                            </div>
                            </a><span class="xuxian"></span><a class="buy_xj" href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>">已购买</a><a href="javascript:;" class="buy_xj" <?= $userInfo['type']==2?'onclick="goExam('.$vkc['id'].')"':''?>>测评</a></li>
					<?			
                        }else{
							$courinfo = DS("publics2._get","","course","id=".$vkc['id']);
							$teach	  =	DS("publics2._get","","users","id=".$courinfo[0]['teach_id']);
                    ...
                    ?>
                        ...
                        <span class="xuxian"></span></a><a class="buy_xj" href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>">免费</a><a href="javascript:;" class="buy_xj" <?= $userInfo['type']==2?'onclick="goExam('.$vkc['id'].')"':''?>>测评</a></li>
                    <?php }else{?>
							<li aid="<?=$vkc['id']?>"><a href="javascript:;" onclick="checkBuy(<?= $slist['id']?>,<?= $vcha['id']?>,<?= $vkc['id']?>,4,'3')" class="buy_title"><?= $vkc['name'];?></a>
                            <div id="shipin_title<?=$vkc['id']?>"  style="display:none;float:left;position:absolute;left:350px;z-index:3;top:0;width:370px;">
                            	<p style="display:inline-block;"><a href="javascript:;" onclick="checkBuy(<?= $slist['id']?>,<?= $vcha['id']?>,<?= $vkc['id']?>,4,'3')" class="buy_title"><img src="images/course_conimg_18.png" /></a></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;">课时：<?= $courinfo[0]['kc_hours']?></p>
                                <p style="color:#666;font-size:12px;margin-left:15px;display:inline-block;">赞（<?= $courinfo[0]['good']?>）踩（<?= $courinfo[0]['bad']?>）</p>
                            </div>
                            <span class="xuxian"></span><a href="javascript:void(0);"  onclick="checkBuy(<?= $slist['id']?>,<?= $vcha['id']?>,<?= $vkc['id']?>,4,'3')" class="buy_xj">购买</a><a href="javascript:;" class="buy_xj" <?= $userInfo['type']==2?'onclick="goExam('.$vkc['id'].')"':''?>>测评</a></li>	
				<?
					}
						}
					}
                    ...
                    <div class="con_list2">     
                        ...
                        ?>
                         <li aid="<?=$vkc['id']?>"><a href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>" class="buy_title"><?= $vkc['name'];?></a>
                         	...
                         	<span class="xuxian"></span><a class="buy_xj" href="<?= URL('courSystem.curriculumEver','classid='.V('r:classid').'&sid='.V('r:sid').'&pid='.$vcha['id'].'&id='.$vkc['id'].'&catid=4')?>">免费</a><a href="javascript:;" class="buy_xj" onclick="jAler()">测评</a></li>
                        <?php }else{?> 
                            <li aid="<?=$vkc['id']?>">
                            ...
                            <a href="javascript:void(0);"  onclick="checkBuy(<?= $slist['id']?>,<?= $vcha['id']?>,<?= $vkc['id']?>,4,'3')" class="buy_xj">购买</a><a href="javascript:;" class="buy_xj" onclick="jAler()">测评</a></li>
						<?  
						}
                                }
                            }
