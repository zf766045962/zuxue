    ...
    ?>
				<li>
                    ...
                    <div class="c-course-info">
                        <div class="c-course-name"><a href="<?= URL('courAdvance.advanceCon','classid='.$sv['couClass'].'&sid='.$sv['id'].'&catid=3');?>" target="_blank"><?php echo $sv['stitle']?></a></div>
                        ...
                        <div class="course-time">
                            <a  class="n-collect" status="0"  href="javascript:void(0);" treeid="9094" onclick="collect(<?= $sv['id']?>,3)"></a>
                            <span>时长：<em><?php echo $sv['sys_hours']?></em></span></div>
                        <div class="course-hover-btn">
                            <span class="study-btn"><a href="<?= URL('courAdvance.advanceCon','classid='.$sv['couClass'].'&sid='.$sv['id'].'&catid=3');?>" target="_blank">开始学习</a></span>       
                            <span class="det-btn"><a title="购买" href="javascript:;" onclick="checkBuy(<?= $sv['id']?>,0,0,3,1)">购买</a></span>
                        </div>
                    </div>
				</li>
	<?
