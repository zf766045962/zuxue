...
<div id="wp" class="wp">
	...
	<div id="pt" class="bm cl" style="display:none;">
		<div class="z">
			<a href="#" class="nvhm" title="首页">学啊-社区</a><em>&raquo;</em>
            <a href="<?= URL('bbs.forum')?>" id="fjump" onmouseover="delayShow(this, 'showForummenu(22)');" class="showmenu" >版块</a> <em>&rsaquo;</em> 
            <a href="<?= URL('bbs.thread_detail')?>">学啊产品</a><em>&rsaquo;</em> 
            <a href="<?= URL('bbs.thread_detail')?>">产品讨论</a>
        </div>
	</div>
    <!--导航-->
    <div class="wp">
