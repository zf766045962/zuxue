			...
			<table summary="forum_22" cellspacing="0" cellpadding="0">
    			...
    			<tbody id="stickthread_4636864">
    				<tr>
						...
						<td class="userhead"><a class="avatar" id="stickthread_<?=$val['pid']?>" onmouseover="wzxx(<?=$val['pid']?>,<?=$val['authorid']?>)"><img src="<?=$nam[0]['head_img']==NULL?'images/noavatar_small.gif':$nam[0]['head_img']?>"  isdrift="true" uid="509495"  onerror="this.onerror=null;this.src='images/noavatar_big.gif'" /><span class="shadowbox_avatar"> </span></a></td>
