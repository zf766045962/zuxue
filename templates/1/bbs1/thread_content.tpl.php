...
<a href="<?= URL('bbsUser.user_broadcast','&id='.$nam[0]['id'])?>" target="_blank" class="xi2"><?=$nam[0]['username']?></a><img src="images/mzvip3.jpg" class="mzvip"/><a href="#" target="_blank" class="mzpower" >
									<? 
									if($nam[0]['points'] < 50){
										echo '普通会员';
				...
				<div class="posttitlewrap">    
					<div class="avatar head_uinfo" onmouseover="showauthor(this, 'userinfo118007890')" data-href="home.php?mod=space&amp;uid=1304289"><img src="<?=$nam[0]['head_img']==NULL?'images/w100h100.jpg':$nam[0]['head_img']?>"  onerror="this.onerror=null;this.src='images/noavatar_big.gif'" /><span class="shadowbox_avatar"> </span></div>
        		...
        		<div class="pi infobar_post">
					...
					<div class="authi"  >
						<a class="name_uinfo xw1" href="<?=URL('bbsUser.user_broadcast','&id='.$nam[0]['id'])?>" target="_blank" title="<?=$nam[0]['username']?>"><?=$nam[0]['username']?></a>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
   ...
   if(xmlhttp.responseText == '请先登录'){
					...
					document.getElementById('tipBoxindex').innerHTML="请先，<a href='javascript:void(0);' onclick='showPop();'>登录</a>";
