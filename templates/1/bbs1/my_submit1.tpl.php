...
<table cellspacing="0" cellpadding="0"  class="guide_theme" >	
	...
	<tbody id="normalthread_5297412">
		<tr>
			<th class="common"><div class="title_guidelist"><a href="<?= URL('bbs.thread_detail','&fid='.$pv['fid']."&tid=".$pv['pid'])?>" target="_blank" class="xst" title="<?= $pv['subject']?>"><?= htmlspecialchars($pv['subject'])?></a></div></th>
			...
			<td class="by" style="padding-right:20px;"><div class="br"><em><?php /*?><a href=""><?php */?><span title="<?= date("m月d日",$pv['dateline'])?>"><?= date("m月d日",$pv['dateline'])?></span></a></em></div></td></tr>
	</tbody>
    <?php
			}
		}else{
