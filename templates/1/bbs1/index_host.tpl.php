                    ...
                    <tr>		
                        <td class="userhead" style="padding:8px 0 !important;" >
                            <a class="avatar" id="stickthread_<?=$v['pid']?>" onmouseover="wzxx(<?=$v['pid']?>,<?=$v['authorid']?>)">
                            	<img src="<?= $nam[0]['head_img'] == NULL?'images/w100h100.jpg':$nam[0]['head_img']?>"  isdrift="true" uid="2199310"  onerror="this.onerror=null;this.src='<?= $nam[0]['head_img'] == NULL?'images/w100h100.jpg':$nam[0]['head_img']?>'" /><span class="shadowbox_avatar"> </span>
                            </a>
                        </td>		
                        ...
                        <span>
                        <a c="1" class="author_list" href="<?= URL('bbsUser.user_broadcast','&id='.$v['authorid'])?>" style="font-size:14px;" hidefocus="true"><?= $nam[0]['username']?></a></span>
                        </td>
                    </tr>
                </tbody>
           	    <? }?>
