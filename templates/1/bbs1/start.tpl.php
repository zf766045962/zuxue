...
<title>162100（头像）截图程序 - Power by 162100.com</title>
...
<div id="allBox">
  <div id="picBox">
    ...
    <form action="<?=URL('bbs1.i_up')?>" method="post" enctype="multipart/form-data" id="pform">
      <div id="picViewOuter"> <b></b><br />
          <br />
        ...
        网络图片：</label><br />
        <div class="sword">
          <input type="text" id="purl2" name="purl2" size="25" class="sinput" onfocus="if(document.getElementById('p2').checked!=true)document.getElementById('p2').checked='checked'" /> 图片URL
        </div>
