...
<link href="/css/bbscss/head.css" type="text/css" rel="Stylesheet"/>
<link href="/css/bbscss/actmanage.css" type="text/css" rel="Stylesheet"/>
<script type="text/javascript">
    var ReceiveEmail = '';
</script>
</head>
<body>
	<div id='1data-text' style="display:none">您的出生地是?</div>
	<div id='2data-text' style="display:none">您母亲的姓名是?</div>
	<div id='3data-text' style="display:none">您父亲的姓名是?</div>
	<div id='4data-text' style="display:none">您配偶的姓名是?</div>
	<div id='5data-text' style="display:none">您的小学校名是?</div>
	<div id='6data-text' style="display:none">您母亲的生日是?</div>
	<div id='7data-text' style="display:none">您父亲的生日是?</div>
	<div id='8data-text' style="display:none">您配偶的生日是?</div>
	<div id='9data-text' style="display:none">您初中班主任的名字是?</div>
	<div id='10data-text' style="display:none">您小时候的绰号是什么?</div>
	<div id='11data-text' style="display:none">您小时候最好的朋友叫什么名字?</div>
	...
	<div class="headRight">
		<span id='loginWrap' style=''>
			<a id="head-name" class='linkAGray' href='#' title="<?= $nam[0]['username']?>"><?= $nam[0]['username']?></a>
...
<div id='navWrap' class="navWrap" style="margin-left:100">
	<ul class="nav">
		...
		<?php /*?><li id="contact"><a href="#" class="linkAGray">账户充值</a></li><?php */?>
	</ul>
</div>
<div class='clear'></div>
			...
			<div class='topWrap'>
				...
				<div class='top-rightWrap'>
					<div id="nickNameTitle" class='lineWrap nickname'>
						...
						<a id='nickNameEdite' class='pointer modify'><i class='i_icon' title="编辑昵称"></i></a>
					...
					<?php /*?><div id="setUserNameWrap" class='lineWrap grayTip ftop' >
				...
				<div class='titleWrap grayBorderB grayBorderTop'>
					...
					<div class='title-rightWrap'>
                        ...
                        <?php
							...
							if($sum > 60 && $sum <= 80){
						?>
						<span id='safeLevel' style="color:orange;"><?=$sum?></span>
                        <?php
							}else if($sum <= 60){
						?>
                        <span id='safeLevel' style="color:red;"><?=$sum?></span>
                        <?php
							}else{
						?>
                        <span id='safeLevel'style="color:green;"><?=$sum?></span>
                        <?php
							}
						?>
				...
				<div class='bodyWrap'>
					...
					<div id='emailWrap' class='lineWrap'>
						...
						<div class='item-middle' id='email-item-middle1' >
							<span id="current_email" class='email bold'><?=substr_replace($nam[0]['email'],"****",1,3);?></span><br>
					...
					<div id='questionWrap' class='lineWrap'>
						<div class='item-left'>密保问题</div>
							...
							<div id="questionModifyTip" class='item-right' >
								<a id="modifySafe" href='javascript:void(0);' class='linkABlue modify' onClick="questry()">修改</a>
							</div>
							<div id="questionSettedTip" class='item-middle'>
								<span id='tip' class='bold'>已设置</span><br> <span
									class='grayTip'>可通过密保问题找回密码</span>
							</div>
					...
					<div id='setQuestion-stepTwo' class='grayBorderT grayBorderB modify_content' style='display:none;'>
						...
						<form class='setQuestion-bodyWrap'>
								...
								<div class='lineWrap'>
									<label class='fleft'>&nbsp;</label>
									<a class="fullBtnBlue save_form fleft" id="ce-u-setQuetionsave" onClick="savess()">保存</a>
						...
						<script>
							function savess(){
								...
								document.getElementById(questionCode1).value
					...
					<div id='changeQuestionWrap' class='grayBorderT grayBorderB modify_content' style='display:none;'>
						...
						<form class='cQuestion-bodyWrap'>	
							<div class='questionlineWrap'>
								...
								<?php /*?>	var ss = document.getElementById('<?=$nam[0]['question1'].'data-text'?>').innerHTML;<?php */?>
								function questry(){
									
									var ss = document.getElementById('<?=$nam[0]['question1'].'data-text'?>').innerHTML ;
									document.getElementById('cqone').innerHTML = ss
									var ss1 = document.getElementById('<?=$nam[0]['qusetry2'].'data-text'?>').innerHTML ;
									document.getElementById('cqtwo').innerHTML = ss1
									}	 
								</script>
...
<div id="wechatPic"></div>
	...
	<script type="text/javascript" src="js/bbsjs/jquery.autoEmail.js" charset="utf-8"></script>
	<script type="text/javascript" src="js/bbsjs/dropdown.js" charset="utf-8"></script>
	<script type="text/javascript" src="js/bbsjs/actmanage.js" charset="utf-8"></script>
