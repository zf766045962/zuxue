...
<script type="text/javascript">
	var STYLEID = '1', STATICURL = 'static/', IMGDIR = 'images/', VERHASH = 'TO2', charset = 'utf-8', discuz_uid = '0', cookiepre = 'MZBBS_2132_', cookiedomain = '', cookiepath = '/', showusercard = '0', attackevasive = '0', disallowfloat = 'login|newthread|tradeorder|activity|debate|usergroups|task', creditnotice = '', defaultstyle = '', REPORTURL = 'aHR0cDovL2Jicy5tZWl6dS5jbi90aHJlYWQtNTI3ODk3OC0xLTEuaHRtbA==', SITEURL = '', JSPATH = '/js/';
// 是否是手机浏览器
