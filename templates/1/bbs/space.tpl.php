...
<title>回复信息 - <?php $site_name = DS('publics.get_index','','site_name'); echo $site_name[0]['value']?>   </title>
                        	...
                        	<form onsubmit="this.message.value = parseurl(this.message.value);ajaxpost('pmform', 'pmforum_return', 'pmforum_return');return false;" action="home.php?mod=spacecp&amp;ac=pm&amp;op=send&amp;pmid=4822438&amp;daterange=0&amp;handlekey=pmsend&amp;pmsubmit=yes" autocomplete="off" method="post" name="pmform" id="pmform">
                                <dl class="cl self_msgdetail">
                                    <dd class="avt head_msgdetail">
										...
										<img src="<?=$info1[0]['logo']==NULL?"images/course_conimg_27.png":$info1[0]['logo']?>"></a>
                                    </dd>
...
<a target="_blank" href="<?=URL('bbsUser.user_broadcast','&id='.$info[0]['id'])?>"><img src="<?=$info[0]['logo']==NULL?"images/course_conimg_27.png":$info[0]['logo']?>"></a>
</dd>
<dd class="cont_msgdetail">
...
<dd class="avt head_msgdetail">
<a target="_blank" href="<?=URL('bbsUser.user_broadcast','&id='.$info22[0]['id'])?>"><img src="<?=$info22[0]['logo']==NULL?"images/course_conimg_27.png":$info22[0]['logo']?>"></a>
</dd>
<dd class="cont_msgdetail">
        <div class="msg_msgdetail">
        	            	<em class="uname_msgdetail">
