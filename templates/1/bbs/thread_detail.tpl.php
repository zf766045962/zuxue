...
<table id="pid118009247" summary="pid118009247" cellspacing="0" cellpadding="0">
    ...
    <tr id='<?=$val['id'] ?>'>
		<td class="pls" rowspan="2"> 
						...
						<a target="_blank" href="<?= URL('bbsUser.user_broadcast','&id='.$val['authorid'])?>" class="hidefocus"><img src="<?= $nam[0]['logo'] == NULL?'images/course_conimg_27.png':$nam[0]['logo']?>"><span class="shadowbox_avatar"> </span></a>
						</div></div>
						<div class="i y" >
							<div>
								<div class="sign_name" >
								
									<a href="<?= URL('bbsUser.user_broadcast','&id='.$val['authorid'])?>" target="_blank" class="xi2"><? echo $nam[0]['realname']?></a><!--<img src="images/mzvip3.jpg" class="mzvip"/>-->
...
<!--除开1楼的显示楼层数-->
							...
							<div class="pti barl_post">
								<div class="pdbt"></div>
                                <div class="authi"  >
                                	<a class="name_uinfo xw1" href="<?= URL('bbsUser.user_broadcast','&id='.$val['authorid'])?>" target="_blank"  title="<? echo $nam[0]['realname']?>"><? echo htmlspecialchars($nam[0]['realname'])?></a>
			...
			xmlhttp.onreadystatechange=function()
			  ...
			  if (xmlhttp.readyState==4 && xmlhttp.status==200)
				...
				if(xmlhttp.responseText == '请先登录'){
					...
					document.getElementById('tipBox'+id).innerHTML="请先，<a onclick='denglu();' href='javascript:void(0);'>登录</a>";
					vart=setTimeout(function(){
...
<script type="text/javascript">
	...
	var disablepostctrl = parseInt('0');
			...
			<div align="center" class="ui-mask" data-widget-cid="widget-0" style=" line-height:135px;position: absolute; width: 592px; height: 135px; margin-left:1px;margin-top:2px;z-index: 998; display: block; opacity: 1; background-color: rgb(249,249 ,249);">
    		 您需要登录后才能回复&nbsp;&nbsp;&nbsp;&nbsp;   
				<a href="javascript:denglu();" class="xi2" style="color:#32A5E7">登录</a>
        <a class="separator"></a>&nbsp;
   
   		 <img src="images/shug.png" style="margin-left:-9px" height='10px'>
    
				<a href="javascript:zhuce();" class="xi2" style="color:#32A5E7">立刻注册</a>
</div>
<? }?>
