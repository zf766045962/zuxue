...
<script type="text/javascript">
	var STYLEID = '1', STATICURL = 'static/', IMGDIR = 'images/', VERHASH = 'WMI', charset = 'utf-8', discuz_uid = '9607427', cookiepre = 'MZBBS_2132_', cookiedomain = '', cookiepath = '/', showusercard = '0', attackevasive = '0', disallowfloat = 'login|newthread|tradeorder|activity|debate|usergroups|task', creditnotice = '', defaultstyle = '', REPORTURL = 'aHR0cDovL2Jicy5tZWl6dS5jbi9ob21lLnBocD9tb2Q9c3BhY2VjcCZhYz1wcm9maWxlJm9wPWNvbnRhY3Q=', SITEURL = 'http://127.0.0.1:8004/', JSPATH = 'js/';
	// 是否是手机浏览器// 手机浏览器 1 
...
<meta name="msapplication-task" content="name=版块;action-uri=<?= URL('bbs.user')?>;icon-uri=images/bbs.ico" />
