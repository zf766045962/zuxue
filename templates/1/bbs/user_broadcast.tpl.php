...
<head>
    ...
    <title><?= $nam[0]['realname']?>的广播 </title>
							...
							<form onsubmit="ajaxpost(this.id, 'return_a_friend_li_5057668');" action="home.php?mod=spacecp&amp;ac=friend&amp;op=add&amp;uid=5057668" name="addform_5057668" id="addform_5057668" autocomplete="off" method="post" fwin="a_friend_li_5057668">
                                ...
                                <div class="c input_w_316">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <th width="60" valign="top" class="avt"><a href="space-uid-5057668.html"><img  src="<?=$nam[0]['logo'] == NULL?'images/course_conimg_27.png':$nam[0]['logo']?>"></a></th>
                                                <td valign="top">添加 <strong><?=$nam[0]['realname']?></strong> 为好友，附言:<br>
                                                    ...
                                                    <p class="mtn xg1">(附言为可选<?=$nam[0]['realname']?> 会看到这条附言，最多50个字符 )</p>
                	...
                	<td id="fwin_content_showMsgBox" class="m_c login_showMsgBox" style="" fwin="showMsgBox">
                    	<div class="pm pm_chat">
							...
							<div class="pm_tac bbda cl">
        						<div class="fll"><?=$nam[0]['realname']?></div>   
        					...
        					<div class="pm_avatar"><img  src="<?=$nam[0]['logo'] == NULL?'images/course_conimg_27.png':$nam[0]['logo']?>"></div>        
							<div class="c">
            ...
            <div id="meizu_space" >
        		<div class="space_box">
                    <div class="meizu_name">
                        <span class="inner_uname"><?=$nam[0]['realname']?></span>
                    ...
                    <div class="avatar_img">
						...
						<?
						if($nam[0]['logo'] == NULL){
							echo 'images/course_conimg_27.png';
							}else{
							echo $nam[0]['logo'];	
								}
						?>
								...
								<div class="feed_li_box" >      	            
            						<div class="flw_article" style="margin-left:0; padding-left:0px;" >
										...
										<?	 $name = DS('publics._get','','bbs_forum','fid='.$v['pid']);?>
                                        	<a class="name_feedlist" href="javascript:;"><?=$nam[0]['realname']?>&nbsp;&nbsp;</a> 发表于 <span title="<?=date('Y-m-d h:i',(int)$v['dateline'])?>"><?=$times?></span>&nbsp;&nbsp;#<a href="<?= URL('bbs.thread','&fid='.$v['pid'])?>"><?=$name[0]['name']?></a>
                                    	</div>
