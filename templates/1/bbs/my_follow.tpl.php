...
<div id="wp" class="wp">
	<div id="ct" class="ct2_a wp cl">
		...
		<div class="back_left bdl ">
        	<dl class="a" id="lf_">
                <dt>个人中心</dt>
                <dd ><a href="<?= $_SESSION['u_uidss']?URL('bbsUser.my_dynamic'):"javascript:denglu();"?>" title="动态">动态</a></dd>
                <dd ><a href="<?= $_SESSION['u_uidss']?URL('bbsUser.my_submit'):"javascript:denglu();"?>" title="帖子">帖子</a></dd>
                <dd class="bdl_a" ><a href="<?= $_SESSION['u_uidss']?URL('bbsUser.my_follow'):"javascript:denglu();"?>" title="关系">关系</a></dd>
                <dd ><a href="<?= $_SESSION['u_uidss']?URL('bbsUser.my_msgs'):"javascript:denglu();"?>" title="消息">消息</a></dd>
...
<li <? if(V('r:ccid') == 1 or V('r:ccid') == NULL){
		echo 'class="a"';}
		?>><a href="<?= $_SESSION['u_uidss']?URL('bbsUser.my_follow','&ccid=1'):"javascript:denglu();"?>">收听</a></li>
<li <?=V('r:ccid') == 2?'class="a"':''?>><a href="<?=$_SESSION['u_uidss']?URL('bbsUser.my_follow','&ccid=2'):"javascript:denglu();"?>">听众</a></li>
<li <?=V('r:ccid') == 3?'class="a"':''?>><a href="<?=$_SESSION['u_uidss']?URL('bbsUser.my_follow','&ccid=3'):"javascript:denglu();"?>">搜索</a></li>
...
<? $ssyou3332 = DS('publics._get','','user_follow','followuid='.$v['id'] . ' and uid = '.$_SESSION['u_uidss'] );	?>	
	...
	<a style="color:#999999;" target="_blank" title="222" href="<?=URL('bbsUser.user_broadcast','&id='.$v['id'])?>"><?=$v['realname']?></a>
	</h4>
...
<? //var_dump($ssyou)?>
					<li class="cl">
<a class="flw_avt" id="edit_avt" title="<?=$users2[0]['realname']?>" href="<?=URL('bbsUser.user_broadcast','&id='.$v['uid'])?>">
                        <em class="avatar"><img src="<?=$users2[0]['logo']==NULL?"images/course_conimg_27.png":$users2[0]['logo']?>" style="cursor: pointer;">                        <span class="shadowbox_avatar"> </span></em>
</a>
		...
		<a style="display:<?=$ssyou==NULL?"":"none"?>" class="flw_btn_fo" onclick="styh(<?=$v['id']?>,<?=$v['uid']?>)" href="javascript:;" id="a_followmod22_<?=$v['id']?>">收听</a>
                                ...
                                <h6 class="pbn xs2 name_ulist"><a c="1" class="xi2" title="<?=$users2[0]['realname']?>" href="<?=URL('bbsUser.user_broadcast','&id='.$v['uid'])?>"><?=$users2[0]['realname']?></a></h6>
...
<? $shuject = DS('publics._get','','bbs_post','authorid ='.$v['followuid'].' order by dateline desc limit 0,1');	?>	
                    <li class="cl">
<a class="flw_avt" id="edit_avt" title="<?=$user2[0]['realname']?>" href="<?=URL('bbsUser.user_broadcast','&id='.$v['uid'])?>">
                        <em class="avatar"><img src="<?=$user2[0]['logo']==NULL?"images/course_conimg_27.png":$user2[0]['head_img']?>">                        <span class="shadowbox_avatar"> </span></em>
</a>
<a class="flw_btn_unfo" onclick="qxst(<?=$v['id']?>,<?=$v['followuid']?>)" href="javascript:;" id="a_followmod_<?=$v['id']?>">取消收听</a>
<h6 class="pbn xs2 name_ulist"><a c="1" class="xi2" title="<?=$user2[0]['logo']?>" href="<?=URL('bbsUser.user_broadcast','&id='.$v['followuid'])?>"><?=$user2[0]['realname']?></a>&nbsp;<span class="xg1 xs1 xw0" id="followbkame_9607427"></span></h6>
