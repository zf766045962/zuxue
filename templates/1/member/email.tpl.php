...
<div class="content">
    ...
    <div class="lib_Contentbox lib_tabborder">
        <div id="con_one_3" class="hover">                        
            <div class="safe_top">
                <p style="font-weight:bold;">绑定后，可以使用邮箱找回密码！</p>
            </div>
            <div class="safe_btm_two">
                <div class="safe_con">
                <form action="<?= URL('member.saveEmail')?>" method="post" id="saveemail" name="saveemail">
                    <p class="safe_two"><span>邮箱号：</span><input type="text" name="email" id="email" /></p>
                    <p class="safe_two"><span>验证码：</span><input type="text" name="yz_text" id="yz_text" class="yz_text" /><input type="button"  id="mybtn" class="yzm" value="获取验证码" onclick="sendEmail()"></p>
