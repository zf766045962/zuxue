...
<div class="content">
    ...
    <div class="lib_Contentbox lib_tabborder">
        <div id="con_one_3" class="hover">                        
            <div class="safe_top">
                <p style="font-weight:bold;">绑定后，可以使用QQ找回密码！</p>
            </div>
            <div class="safe_btm_two">
                <div class="safe_con">
                    <p class="safe_two"><img src="images/qq_img_03.png" /></p>
                    <p class="safe_two safe_qq">未绑定QQ账号</p>
                    <p class="safe_two"><input type="button" name="" id="" class="two_btn" value="立即绑定" /></p>
                </div>
            </div>
        </div>
    </div>
