 ...
 * 序列号,请通过亿美销售人员获取
 */
$serialNumber = '6SDK-EMY-6688-KJXPT';
...
function registDetailInfo()
{
	...
	$eName = "乡村之家（天津）软件开发科技有限公司";
	$linkMan = "赵志强";
	$phoneNum = "022-59116660";
	$mobile = "13920705456";
	$email = "wwwzhaozhiqiang@126.com";
	$fax = "010-1111111";
	$address = "xx路";
	$postcode = "111111";
...
function sendSMS()
{
	 ...
	 */
	//$statusCode = $client->sendSMS(array('13920705456','159xxxxxxxx'),"test2测试");
	$statusCode = $client->sendSMS(array('18512251892'),"【乡村之家】  本次短信验证码为9527。");
	echo "处理状态码:".$statusCode;
}
