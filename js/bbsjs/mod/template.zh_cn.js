...
Xwb.ax.Tpl.reg({
    ...
    Box : [
        '<div class="win-pop {.cs}">',
			...
			'[?.closeable?<a href="#" class="ico-close-btn" id="xwb_cls" title="关闭"></a>?]',
            '{.boxOutterHtml}',
        '</div>'
     ].join(''),
     ...
     ForwardDlgContentHtml : [
            ...
            '<div class="forward-tool"><span id="xwb_warn_tip">还可以输入140字</span><a href="#" class="icon-face-choose" id="xwb_face_trig"></a></div>',
	...
	EmotionHotList: '<div class="hot-e-list" id="hotEm">{.hotList}</div>',
     ...
     CommentArea : [
        '<div class="feed-comment box-style hidden">',
          ...
          '<div class="box-content">{.cmtBoxHtml}<ul id="cmtCt" class="hidden"></ul><div class="more-comment" id="more">还有<span id="lefCnt"></span>条评论，<a href="{.cmtUrl}">点击查看</a></div>',
          '</div>',
        ...
        '<div class="box-content">',
            '<div class="post-comment">',
                '<div class="post-comment-main">',
                    ...
                    '<a href="javascript:;" class="btn-s1" rel="e:sd"><span>评论</span></a>',
    ...
    Comment : [
        '<li rel="c:{.id},n:{.nick}">',
            ...
            '<div class="comment-content">',
                ...
                '<div>[?.canDel?<a class="ico-del" href="javascript:;" rel="e:dl">删除</a>?]<a class="ico-reply" href="javascript:;" rel="e:rp">回复</a></div>',
            '</div>',
        '</li>'
    ].join(''),
        ...
        '<li rel="c:{.id},n:{.nick}">',
            ...
            '<div class="comment-c">',
                ...
                '<div class="c-for" id="trigs">',
                    '<a href="javascript:;" class="ico-reply" rel="e:rp">回复</a>',
					'[?.canDel?<a href="javascript:;" class="ico-del" rel="e:dl">删除</a>?]',
                '</div>',
                '{.cmtBoxHtml}',
            '</div>',
        '</li>'
    ...
    MediaBoxContentHtml : [
			'<div class="insert-box">',
				...
				'<input type="text" id="xwb_inputor" class="style-normal"><a href="#" class="btn-s1" rel="e:ok"><span>确定</span></a>',
	...
	PictureBox: [
		...
		'   <a href="{.org}" target="_blank" class="ico-src">查看原图</a>',
		'   <a href="#" class="ico-turnleft" rel="e:tl">向左转</a>',
		'   <a href="#" class="ico-turnright" rel="e:tr">向右转</a></p>',
	...
	PictureBoxForward: [
		...
		'<p><a class="ico-piup" rel="e:zo" href="#">收起</a><a class="ico-src" target="_blank" href="{.org}">查看原图</a><a rel="e:tl" class="ico-turnleft" href="#">向左转</a><a rel="e:tr" class="ico-turnright" href="#">向右转</a></p>',
		'<div name="img"></div></div>'
	].join(''),
    ...
    UploadImgBtn : '<a href="#" rel="e:dlp" class="ico-close-btn" title="删除"></a>',
    
    SearchDropdownList : '<ul class="head-searchlist"><li class="mouseover">含<span></span>的微博</li><li>名<span></span>的人</li></ul>',
    
    PrivateMsgContent : [
        '<div class="field"><label>发私信给：</label><input class="style-normal" type="text" id="sender" /><span class="tips-wrong hidden" id="warnPos">她还没有关注你,暂时不能发私信</span></div>',
        ...
        '<div class="field-area">',
			...
			'<span class="tips-txt" id="word">您还可以输入140字</span>',
        '</div>'
    ].join(''),
    ...
    NoticeLayer : [
        '<div class="new-tips-fixed hidden">',
            '<h4 id="xwb_title">提示</h4>',
                ...
                '<p id="refer" class="hidden"><span id="c">0</span>条微博提到你，<a href="{.referUrl}">点击查看</a></p>',
    ...
    NoticeLayer2 : [
        '<div class="new-tips">',
            ...
            '<a id="refer" class="hidden" href="{.referUrl}"><span id="c">0</span>条微博提到你</a>',
    ...
    PostBoxContent : [
        '<div class="post-box">',
            '<div class="post-title" id="postTitle">有什么新鲜事告诉大家？</div>',
            ...
            '<div class="add-area">',
				...
				'<div class="share-upload-pic" id="uploadBtn">',
					...
					'</form>',
					'<a class="ico-pic" href="#" id="xwb_btn_img">图片</a>',
				'</div>',
                '<a class="ico-video" href="#" id="xwb_btn_vd" rel="e:vd">视频</a>',
                '<a class="ico-music" href="#" id="xwb_btn_ms" rel="e:ms">音乐</a>',
                '<a class="ico-topic" href="#" id="xwb_btn_tp" rel="e:tp">话题</a>',
            '</div>',
            '<div class="share-btn" rel="e:sd"></div>',
            '<div class="post-success hidden" id="xwb_succ_mask"><span class="icon-success"></span>发布成功！</div>',
			'<div class="post-verify ico-verify hidden" id="xwb_veri_mask">信息已进入审核中</div>',
        '</div>'
    ].join(''),
    ...
    SpanBoxContent : [
        '<div class="win-box-inner">',
            ...
            '<div class="foot-con">',
                ...
                '<div class="btn-area">',
                    '<a href="#" class="btn-s1 btn-s1-light" rel="e:ok"><span>确认举报</span></a>',
                    '<a href="#" class="btn-s1" rel="e:cancel"><span>取消</span></a>',
                '</div>',
            '</div>',
        '</div>'
    ].join(''),
    addFollowContent:['<input type="text" id="Content"/><a class="btn-s1" href="javascript:;" rel="e:submit" ><span>保存</span></a>',
                    '<p>请添加想关注的话题</p>',
    ...
    evevtApplicants:['<div class="field"><label>联系方式：</label><input type="text" name="contact" id="contact"/></div>',
        ...
        '          <div class="field-area">',
        '            <a href="javascript:;" class="btn-s1 btn-s1-light fl" rel="e:sd"><span>发送</span></a>',
        '            <span class="tips-txt" id="tips">说明：长度不能超过100个字</span>',
        '            <span class="tips-wrong hidden" id="wrong">这里是提示信息</span>',
        '        </div>'].join(''),
     ...
     colorBox : ['<ul>',
				...
				'</ul>',
				'<div class="btn-area">',
					'<a href="#" class="btn-s1" rel="e:comf"><span>确定</span></a>',
				'</div>'].join(''),
	...
	verify :	'<div class="verify-c tips ico-verify">该信息在审核中，请稍后再试！</div>'
});