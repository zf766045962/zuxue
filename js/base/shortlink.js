...
* <pre><code>
    // 指明要解析的短链前缀
    var shortlink = new Xwb.ax.Shortlink({ local:'http://Xsmarturl.cn' });
    
    var testUrl = 'http://Xsmarturl.cn/aBcDeF';
    
    // true
    shortlink.is(testUrl);
    
    testUrl = 'a text including http://Xsmarturl.cn/aBcDeF,http://Xsmarturl.cn/DefGHE';
...
* <pre><code>
    {
        // 实际地址
        url :	"http://x.Xsmart.com/pr...Y6XTWIwA/?rpid=58114392",
...
X.ax.Shortlink.prototype = {
     ...
     * 
    * <pre><code>
        var text = 'Xsmart,2011 go go go!http://testurl.cn/Xsmart_trunk/hBACWI';
    ...
    * <pre><code>
            var text = 'http://testurl.cn/Xsmart_trunk/hBACWI';
            var linkId;
            if((linkId=is(text))){
                // hBACWI
                alert(linkId);
