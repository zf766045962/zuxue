...
SWFUpload.prototype.initSettings = function (userSettings) {
	...
	//input Settings
	this.ensureDefault("img_input", "imgurl");
	this.ensureDefault("img_urlcha", "img_urlcha");
...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	...
	return ['<object id="', this.movieName, '" type="application/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload" style="vertical-align:top;">',
...
SWFUpload.prototype.uploadSuccess = function (file, serverData, responseReceived) {
	file = this.unescapeFilePostParams(file);
	var jsonserverData = jQuery.parseJSON(serverData);
	if(this.settings.img_input.indexOf("[")>=0)
	{
		$("input[id='"+this.settings.img_input+"']").val(jsonserverData.SAVEFILENAME);
	}
	else
	{
		$("#"+this.settings.img_input).val(jsonserverData.SAVEFILENAME);
	}
	if(this.settings.img_urlcha!="" && this.settings.img_urlcha)
	{
		if(this.settings.img_urlcha.indexOf("[")>=0)
		{
			$("input[id='"+this.settings.img_urlcha+"']").attr("src",jsonserverData.SAVEFILENAME);
		}
		else
		{
			$("#"+this.settings.img_urlcha).attr("src",jsonserverData.SAVEFILENAME);
		}
	}
