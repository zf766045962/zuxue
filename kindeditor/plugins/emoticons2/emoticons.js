/*******************************************************************************
* @author panderman
* @完善作者：stepday <stepday@foxmail.com>
* @site http://www.stepday.com/
...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        //大对象
        FaceHandler = {
            imageFolders: { tab0: 'jx2/', tab1: 'tsj/', tab2: 'ldw/', tab3: 'bobo/', tab4: 'babycat/', tab5: 'face/', tab6: 'youa/', tab7: 'qq/' },
            imageWidth: { tab0: 35, tab1: 35, tab2: 35, tab3: 35, tab4: 35, tab5: 35, tab6: 35, tab7: 24 },
            imageCols: { tab0: 11, tab1: 11, tab2: 11, tab3: 11, tab4: 11, tab5: 11, tab6: 11, tab7: 11 },
            imageColWidth: { tab0: 3, tab1: 3, tab2: 3, tab3: 3, tab4: 3, tab5: 3, tab6: 3, tab7: 3 },
            imageCss: { tab0: 'jd', tab1: 'tsj', tab2: 'ldw', tab3: 'bb', tab4: 'cat', tab5: 'pp', tab6: 'youa', tab7: 'qq' },
            imageCssOffset: { tab0: 35, tab1: 35, tab2: 35, tab3: 35, tab4: 35, tab5: 25, tab6: 35, tab7: 24 },
            tabExist: [0, 0, 0, 0, 0, 0, 0, 0]
        };
            ...
            for (; i < imgNum; ) {
                ...
                for (var j = 0; j < imgColNum; j++, i++) {
                    ...
                    if (faceImage) {
                        ...
                        if (tabName == "tab7")
                            textHTML.push('<img   title="' + infor + '" src="' + sUrl + '" width="' + iWidth + '" height="' + iHeight + '"></img>');
                        else
