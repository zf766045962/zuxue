    ...
    PPTBox.prototype =
    {
        ...
        flashHTML : function(url,width,height,idx) {
            ...
            if(isFlash){
                ...
                + "codebase='/download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0' width='"+width+"' height='"+height+"'>"
                + "<param name=\"movie\" value=\""+url+"\" />"
                + "<param name='quality' value='high' />"
                + "<param name='wmode' value='transparent'>"
                + "<embed src='"+url+"' quality='high' wmode='opaque' pluginspage='/www.macromedia.com/go/getflashplayer'"
